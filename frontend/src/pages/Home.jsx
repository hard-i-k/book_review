...
const features = [
  { title: 'Add New Books', desc: 'Share your favorite reads with the community.', icon: null },
  { title: 'Write Reviews', desc: 'Express your thoughts and help others discover great books.', icon: null },
  { title: 'Rate Books', desc: 'Give books a star rating and see what others think.', icon: null },
  { title: 'Filter & Discover', desc: 'Find books by genre, author, or rating.', icon: null },
];
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button
              ...
              className="bg-gradient-to-r from-purple-600 to-blue-500 text-white px-8 py-3 rounded-full text-lg font-semibold shadow-lg hover:scale-105 hover:from-blue-500 hover:to-purple-600 transition-all duration-200"
            >
              Get Started
            </button>
            <Link
              to="/login"
              className={`bg-white/10 text-purple-200 border border-purple-400 px-8 py-3 rounded-full text-lg font-semibold shadow hover:bg-purple-900/30 transition-all duration-200 ${loggedIn ? 'opacity-50 pointer-events-none' : ''}`}
            >
              Login
            </Link>
          </div>
