  ...
  return (
    <nav className="w-full flex justify-between items-center py-6 px-4 max-w-5xl mx-auto">
      ...
      <div>
        {!loggedIn ? (
          <>
            <Link to="/login" className="text-purple-200 font-semibold hover:underline mr-4 transition-all duration-200">Login</Link>
          ...
          <>
            <button onClick={handleLogout} className="bg-gradient-to-r from-purple-600 to-blue-500 text-white px-4 py-2 rounded-lg shadow hover:from-blue-500 hover:to-purple-600 transition-all duration-200 mr-4">Logout</button>
